...
//  first_app
//
//  Created by Adrian Rupala on 13.03.2018.
    ...
    */
    ...
    @objc func ratingButtonTapped(button: UIButton){
        ...
        if selectedRating == rating {
            ...
            //Otherwise set the ratting to the selected star
    ...
    private func setupButtons() {
        ...
        for _ in 0..<starCount {
            ...
            //utton.accessibilityLabel = "Set \(index + 1) star rating"
            ...
            // Add the new button to the raing button array
    ...
    private func updateButtonSelectionStates(){
        for (index, button) in ratingButtons.enumerated() {
            ...
            //Asking the hint string and value string
